...
interface SourcegraphWebAppState
    ...
    activation2?: Pick<Activation2, 'steps' | 'update' | 'refetch'>
    activation2Completed?: { [key: string]: boolean }
}
            ...
            authenticatedUser.subscribe(
                authenticatedUser =>
                    this.setState({
                        ...
                        activation2:
                            !window.context.sourcegraphDotComMode && authenticatedUser
                                ? this.createActivationStatus2(authenticatedUser.siteAdmin)
                                : undefined,
                    }),
                () => this.setState({ authenticatedUser: null, activation: undefined, activation2: undefined })
            )
        )
